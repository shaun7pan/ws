...
use crate::handlers::teacher::delete_teacher;
use crate::handlers::teacher::get_all_teachers;
use crate::handlers::teacher::get_teacher_details;
use crate::handlers::teacher::post_new_teacher;
use actix_web::web;
...
pub fn teacher_routes(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("/teachers")
            ...
            .route("/{teacher_id}", web::put().to(update_course_details))
