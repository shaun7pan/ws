...
use crate::models::{TeacherRegisterForm, TearcherResponse};
...
pub async fn handle_register(
    ...
    if params.name == "Dave" {
        ...
        let teacher_response: TearcherResponse = serde_json::from_str(&std::str::from_utf8(&res)?)?;
